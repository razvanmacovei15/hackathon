...
class BabyStepsStep3 extends Component
{
    public $currentEmergencyFund = 0;
    public $targetEmergencyFund = 0;
    public $progress = 0;
    ...
    public function mount()
    {
        ...
        if ($financialSituation) {
            ...
            $this->targetEmergencyFund = $financialSituation->monthly_expenses * 6; // 6 months of expenses
    ...
    {
        return view('livewire.baby-steps.step3');
    }
} 